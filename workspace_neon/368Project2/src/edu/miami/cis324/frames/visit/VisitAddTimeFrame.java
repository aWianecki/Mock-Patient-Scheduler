...
public class VisitAddTimeFrame extends JInternalFrame {
    ...
    public VisitAddTimeFrame(Scheduler scheduler, int patientID, int doctorID) {
    ...
    class SaveListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
        	...
        	if(matcher.matches()) {
        		...
        		visitDate.setHours(hour);
        		visitDate.setMinutes(min);
        		Visit<Integer, Integer> v = new VisitImpl<Integer, Integer>(patientID, doctorID, visitDate);
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new VisitAddTimeFrame(scheduler, patientID, doctorID);
