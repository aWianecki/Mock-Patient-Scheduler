...
public class PatientRemoveFrame extends JInternalFrame implements ListSelectionListener {
    private JList list;
    ...
    public PatientRemoveFrame(Scheduler scheduler, ObjectOutputStream oOut) {
        super("Patients", 
              true, //resizable
              true, //closable
              true, //maximizable
    ...
    class EditListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            PatientViewEditFrame pve= new PatientViewEditFrame(scheduler, oOut, p);
            pve.setVisible(true);
            getParent().add(pve);
        }
    }
    ...
    class VisitsListener implements ActionListener {
    	 public void actionPerformed(ActionEvent e) {
             ...
             VisitViewListFrame VVAPF = new VisitViewListFrame(scheduler, oOut, p.getPatientID(), true, true);
             VVAPF.setVisible(true);
             getParent().add(VVAPF);
    	 }
    }
    ...
    class FutureVisitsListener implements ActionListener {
    	public void actionPerformed(ActionEvent e) {
    		...
    		VisitViewListFrame VVFPF= new VisitViewListFrame(scheduler, oOut, p.getPatientID(), true, false);
    		VVFPF.setVisible(true);
    		getParent().add(VVFPF);
   	 }
   }
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new PatientRemoveFrame(scheduler, oOut);
